...
export default function DueLink() {
  ...
  return (
    <Link
      ...
      className="flex min-h-11 items-center gap-2 rounded-lg px-3 text-sm font-medium text-[var(--color-primary)] transition-colors hover:bg-[var(--color-muted)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-ring)]"
    >
      חזרה יומית
