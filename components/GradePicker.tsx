...
const bands = [
  { label: "יסודי", range: "א׳–ו׳", ids: [1, 2, 3, 4, 5, 6], primary: true },
  { label: "חטיבת ביניים", range: "ז׳–ט׳", ids: [7, 8, 9], primary: false },
  { label: "תיכון", range: "י׳–י״ב", ids: [10, 11, 12], primary: false },
];
